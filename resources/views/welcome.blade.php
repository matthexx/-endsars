...
<div class="timeline-container" id="timeline-1">
  <div class="timeline-header">
    <h2 class="timeline-header__title" style="color: red; font-family: BloodThirst;">#END SARS</h2>
    <h3 class="timeline-header__subtitle">A curation of the national protest media agaist #policebrutality and violence </h3>
    <button class="btn"> <a data-toggle="modal" data-target="#modalLoginAvatar" href=""> Upload Media</a></button>

  </div>
  <div class="timeline">
    <div class="timeline-item" data-text="FATHER OF THE TURKS">
      <div class="timeline__content"><a href="/gallery"><img class="timeline__img" src="images/Aisha-Yesufu-EndSARS.jpeg"/></a>
        <h2 class="timeline__content-title">October 8, 2020</h2>
    ...
    <div class="timeline-item" data-text="FATHER OF THE TURKS">
      <div class="timeline__content"><img class="timeline__img" src="images/EndSARS-4.png"/>
        <h2 class="timeline__content-title">October 9, 2020</h2>
    ...
    <div class="timeline-item" data-text="FATHER OF THE TURKS">
      <div class="timeline__content"><img class="timeline__img" src="images/quidax.jpeg"/>
        <h2 class="timeline__content-title">October 10, 2020</h2>
    ...
    <div class="modal-dialog cascading-modal modal-avatar modal-sm" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <img style="margin: 0 auto;" width="100px" src="images/sponsors/quidax.jpg" alt="avatar" class="rounded-circle img-responsive">
        </div>
        <!--Body-->
        <div class="modal-body text-center mb-1">
    
          <h5 class="mt-1 mb-4">Soro soke!</h5>
    
          <div class="md-form ml-0 mr-0">
            <label  style="float:left; font-size: 0.6em; font-style: italic;" data-error="wrong" data-success="right" for="form29" class="mr-0">Leave blank to post anonymously</label>
            <input  style="outline: none; margin-bottom: 6px;" type="text" id="form29" class="form-control form-control-sm validate ml-0">
          </div>

          <div class="md-form ml-0 mr-0">
            <label  style="float:left; font-size: 0.6em; font-style: italic;" data-error="wrong" data-success="right" for="form29" class="mr-0">Event date</label>
            <input  style="outline: none; margin-bottom: 6px;" type="date" id="form29" class="form-control form-control-sm validate ml-0">
          </div>

          <div class="md-form ml-0 mr-0 mt-4">
            <label style="float:left; font-size: 0.6em; font-style: italic;" data-error="wrong" data-success="right" for="form29" class="mr-0">Upload a video or image from your protest</label>
            <input style="outline: none;" type="file" accept="video/*|image/*|media_type" id="form29" class="form-control form-control-sm validate ml-0">
          </div>
    
          <div class="text-center mt-4">
            <button class="btn_modal mt-1">Upload <i class="fas fa-sign-in ml-1"></i></button>
          </div>
        </div>
...
<div class="demo-footer">
  ...
  <h6 style=" font-style: italic; " target="_blank">Thanks for believeing in the NEW <span style="padding: 4px; background-color:#000;"> <span style="color: green;">NI</span> <span style="color: #fff;">GER</span> <span style="color: green;">IA</span></span></h6> 
  <hr class="thr" style="width:10%;">

  <div style="margin-top: 30px;" class="sponsors">
    <img class="sp_img" src="images/sponsors/Bundle-logo.svg" alt="">
    <img class="sp_img" src="images/sponsors/empawa.jpg" alt="">
    <img class="sp_img" src="images/sponsors/SYH.jpg" alt="">
    <img class="sp_img" src="images/sponsors/feminist.png" alt="">
    <img class="sp_img" src="images/sponsors/budgit.jpg" alt="">
    <img class="sp_img" src="images/sponsors/qq.png" alt="">
    <img class="sp_img" src="images/sponsors/Main.png" alt="">
    <img class="sp_img" src="images/sponsors/flutter.jpg" alt="">
    <!-- <img class="sp_img" src="images/sponsors/annon.jpg" alt=""> -->
  ...
  <a href="" target="_blank">@TheSTEMEducator</a>
</div>
